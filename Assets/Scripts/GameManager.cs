    ...
    IEnumerator EnemySpawner()
    {
        ...
        while (!gameOver && spawnEnemies)
        {
            if (!pause)
            {
                ...
                {
                    case 0:
                        m_pooler.Spawner127(new Vector3(Random.Range(-6f, 6.1f), 14.76f, 0), Quaternion.identity);
                        break;
                    case 1:
                        m_pooler.PursuerSpawner(new Vector3(Random.Range(-6f, 6.1f), 14.76f, 0), Quaternion.identity);
                        break;
                    case 2:
                        m_pooler.MissileSpawner(new Vector3(Random.Range(-6f, 6.1f), 14.76f, 0), Quaternion.identity);
                        break;
                    case 3:
                        m_pooler.BombSpawner(new Vector3(Random.Range(-6f, 6.1f), 14.76f, 0), Quaternion.identity);
                        break;
                    case 4:
                        m_pooler.BigSpawner(new Vector3(Random.Range(-6f, 6.1f), 14.76f, 0), Quaternion.identity);
                        break;
                    case 5:
                        m_pooler.HarpySpawner(new Vector3(Random.Range(-6f, 6.1f), 14.76f, 0), Quaternion.identity);
                        break;
                }
